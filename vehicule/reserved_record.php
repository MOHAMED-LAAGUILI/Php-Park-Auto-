		...
		<div class="card">
			...
			<div class="page-header">
              <h3 class="page-title">
                ...
                </span>All finished reservations Record
              </h3>
            </div>
				...
				<div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
					<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
						<thead>
							...
							<th data-priority="2">ID vehicules</th>
							<th data-priority="3">BRAND</th>
							<th data-priority="4">MODEL</th>
							<th data-priority="5">LICENSE</th>
							<th data-priority="6">DATE RESERVATION</th>
							<th data-priority="7">DATE RETURNING</th>
						</tr>
					</thead>
					<tbody>
						...
						<?php
						require '../config.php';
					$sql = "SELECT * FROM `reserved_record`;";
