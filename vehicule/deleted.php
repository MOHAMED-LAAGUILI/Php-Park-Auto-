					...
					<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
						<thead>
							<tr>
								...
								<th data-priority="4">LICENSE</th>
								<th data-priority="5">COLOR</th>
								<th data-priority="6">OBSERVATION</th>
								<th data-priority="7">DELETED DATE</th>
						...
						<tbody>
							...
							$sql = "SELECT * FROM `deleted_vehicules`;";
